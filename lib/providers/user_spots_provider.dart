...
class UserSpotsNotifier extends StateNotifier<List<String>> {
  UserSpotsNotifier() : super([]);
...
final userSpotsProvider =
    StateNotifierProvider<UserSpotsNotifier, List<String>>((ref) {
  return UserSpotsNotifier();
});
